...
public class SwitchButton extends View implements Checkable {
    ...
    private boolean isPressed; //是否点击
    ...
    private void broadcastEvent() {
        if (onCheckedChangeListener != null && isPressed) {
     ...
     * 打开指示线长
     */
    protected float checkLineLength;
    /**
     * 关闭圆圈颜色
     */
     ...
     * 打开指示线位移X
     */
    protected float checkedLineOffsetX;
    /**
     * 打开指示线位移Y
     */
    protected float checkedLineOffsetY;
